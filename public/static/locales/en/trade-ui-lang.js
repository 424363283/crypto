var tradeUiLang = {
    ...
    "生效时间": "TIF",
    "GTC (有效直到取消): 此种订单将持续有效，直到完全成交或被取消。": "GTC (Good Till Cancelled): Remain in effect until fully filled or cancelled",
    ...
    "FOK (全部成交或取消): 此种订单必须立即全部成交，否则将被全部取消。": "FOK (Fill or Kill): Must be filled immediately, otherwise it will be cancelled",
    "指南": "Guide",
    ...
    "強平價格的計算考慮了您現有的持倉，持有倉位的未實現盈虧和占用保證金將影響強平價格計算。": "Your open positions will be taken into consideration when calculating the liquidation price. Unrealized PNL and maintenance margin of your open position will affect the calculation of liquidation price.",
    "开仓均价": "Average",
    "操作": "Action",
    "增加仓位": "Add Position",
    "目标价格": "Target Price",
    "GTC(GoodtillCancel)": "GTC (Good Till Cancelled)",
    "普通限价单，一直有效直至取消": "Remain in effect until fully filled or cancelled",
    ...
    "订单若不能全部成交则立即全部取消。": "Must be filled immediately, otherwise it will be cancelled",
    "杠杆修改成功": "Adjusted",
