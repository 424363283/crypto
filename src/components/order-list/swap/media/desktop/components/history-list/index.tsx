...
export const HistoryList = ({ active, wallet }: { active: boolean, wallet?: WalletKey }) => {
  ...
  const { data: originFilterList, loading, onSubmit, onLoadMore, orderCounts } = useData({ isUsdtType, scrollToTop, subWallet: wallet });
  ...
  return (
    <>
      <div className={clsx('history-list')}>
        <div className={clsx('order-type-select-wrapper')}>
