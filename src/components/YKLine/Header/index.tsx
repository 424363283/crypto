...
const Header: FC<HeaderProps> = (props) => {
  ...
  const [extensionResolution, setExtensionResolution] =
    useState<ResolutionInfo | null>(null);

  const [originalKLineStyleOpen, setOriginalKLineStyleOpen] = useState(false);

  useEffect(() => {
    const index = resolutionList.findIndex(
      (item) => item.resolution === kLineResolution
    );
    if (index > -1) {
      setExtensionResolution(null);
    } else {
      const resolution =
        ALL_RESOLUTION_INFO.find(
          (item) => item.resolution === kLineResolution
        ) ?? null;
  ...
  return (
    <div className={styles.headerContainer}>
      ...
      <div ref={rootEl} className={classNames(styles.header, 'mobile-header')}>
        <div className={styles.kline_btn}>
          {resolutionList.map((item) => (
            <div
              ...
              className={classNames(
                styles.timeBtn,
                kLineResolution == item.resolution && styles.activeTimeBtnBtn
              )}
              onClick={() => {
          ...
          {extensionResolution && (
            <div
              className={classNames(
                styles.timeBtn,
                kLineResolution == extensionResolution.resolution &&
                  styles.activeTimeBtnBtn
              )}
            >
        ...
        <div className={styles.RightsetTing}>
                    ...
                    {[
                      ...
                      return (
                        <li
                          ...
                          className={classNames(
                            styles.popoverItem,
                            key === originalKLineStyle && styles.selected
                          )}
                          onClick={() => {
              ...
              >
                  ...
                  <span className={styles.headerIcon}>
                    ...
                    <YIcon.SquareFilled
                      className={classNames(
                        styles.arrow,
                        originalKLineStyleOpen && styles.rotate
                      )}
                    />
                  </span>
          ...
          <span>
            ...
            <span className={styles.KlineHistoryOrderOutlinedName}>
              ...
              <div className={classNames(styles.popoverWrapper)}>
                ...
                >
                  ...
                  <CheckBox
                    ...
                    // theme={theme}
                    onChange={() =>
                      setShowPositionTPSLLine?.(!showPositionTPSLLine)
                    }
                ...
                >
                  ...
                  <CheckBox
                    ...
                    // theme={theme}
                    onChange={() =>
                      setShowCurrentEntrustLine?.(!showCurrentEntrustLine)
                    }
                ...
                >
                  <CheckBox
                    ...
                    onChange={() =>
                      setShowHistoryOrderMark?.(!showHistoryOrderMark)
                    }
                    // @ts-ignore
                    label={
                      <Tooltip
                      ...
                      >
                        <span
                          className={styles.historicalOrdersContent}
                          style={{ marginLeft: 0 }}
                        >
