...
const stopLossOverlay: OverlayTemplate = {
  ...
  createPointFigures: ({ coordinates, bounding, overlay, xAxis, yAxis }) => {
    ...
    const marginLeft = positonExtendData.positionBtnFigure.styles.width + 
                      ...
                      takeProfitExtendData.takeProfitBtnFigure.styles.width + btnSpace +
                      btnSpace
    const figures = []
    const lineFigure = {
        type: 'line',
    ...
    const stopLossBtnFigure = {
      ...
      const stopLossBtnWidth = stopLossBtnFigure.styles.paddingLeft +  calcTextWidth(stopLossBtnFigure.attrs.text, stopLossBtnFigure.styles.size, stopLossBtnFigure.styles.weight, stopLossBtnFigure.styles.family) + stopLossBtnFigure.styles.paddingRight
