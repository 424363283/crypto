...
function log(templateText, tagStyle, messageStyle, api, invalidParam, append) {
  if (DEV) {
    var apiStr =
      api !== '' ? 'Call api `'.concat(api, '`').concat(invalidParam !== '' || append !== '' ? ', ' : '.') : '';
    var invalidParamStr =
      invalidParam !== '' ? 'invalid parameter `'.concat(invalidParam, '`').concat(append !== '' ? ', ' : '.') : '';
...
function logWarn(api, invalidParam, append) {
  log(
    ...
    api,
    invalidParam,
    append !== null && append !== void 0 ? append : ''
  );
}
...
function logTag() {
  log(
    '%c❤️ Welcome to klinecharts. Version is 9.8.12',
...
function formatThousands(value, sign) {
  ...
  if (vl.includes('.')) {
    ...
    return ''
      .concat(
        arr[0].replace(/(\d)(?=(\d{3})+$)/g, function ($1) {
...
function getPixelRatio(canvas) {
  var _a, _b, _c;
  return (_c =
    (_b = (_a = canvas.ownerDocument) === null || _a === void 0 ? void 0 : _a.defaultView) === null || _b === void 0
      ? void 0
      : _b.devicePixelRatio) !== null && _c !== void 0
    ? _c
    : 1;
}
function createFont(size, weight, family) {
  return ''
    .concat(weight !== null && weight !== void 0 ? weight : 'normal', ' ')
    .concat(size !== null && size !== void 0 ? size : 12, 'px ')
    .concat(family !== null && family !== void 0 ? family : 'Helvetica Neue');
}
/**
...
function eachFigures(kLineDataList, indicator, dataIndex, defaultStyles, eachFigureCallback) {
  ...
  figures.forEach(function (figure) {
    ...
    if (isValid(defaultFigureStyles)) {
      ...
      var ss =
        (_a = figure.styles) === null || _a === void 0 ? void 0 : _a.call(figure, cbData, indicator, defaultStyles);
...
var IndicatorImp = /** @class */ (function () {
  function IndicatorImp(indicator) {
    ...
    var name = indicator.name,
      ...
      regenerateFigures = indicator.regenerateFigures,
      createTooltipDataSource = indicator.createTooltipDataSource,
      draw = indicator.draw;
    this.name = name;
    ...
    this.shouldFormatBigNumber =
      shouldFormatBigNumber !== null && shouldFormatBigNumber !== void 0 ? shouldFormatBigNumber : false;
    ...
    this.createTooltipDataSource =
      createTooltipDataSource !== null && createTooltipDataSource !== void 0 ? createTooltipDataSource : null;
  ...
  IndicatorImp.prototype.setCalcParams = function (params) {
    ...
    this.figures =
      (_b = (_a = this.regenerateFigures) === null || _a === void 0 ? void 0 : _a.call(this, params)) !== null &&
      _b !== void 0
        ? _b
        : this.figures;
    return true;
...
var OverlayImp = /** @class */ (function () {
  function OverlayImp(overlay) {
    ...
    var mode = overlay.mode,
      ...
      createPointFigures = overlay.createPointFigures,
      createXAxisFigures = overlay.createXAxisFigures,
      createYAxisFigures = overlay.createYAxisFigures,
      performEventPressedMove = overlay.performEventPressedMove,
      performEventMoveForDrawing = overlay.performEventMoveForDrawing,
      onDrawStart = overlay.onDrawStart,
      onDrawing = overlay.onDrawing,
      onDrawEnd = overlay.onDrawEnd,
      onClick = overlay.onClick,
      onDoubleClick = overlay.onDoubleClick,
      onRightClick = overlay.onRightClick,
      onPressedMoveStart = overlay.onPressedMoveStart,
      onPressedMoving = overlay.onPressedMoving,
      onPressedMoveEnd = overlay.onPressedMoveEnd,
      onMouseEnter = overlay.onMouseEnter,
      onMouseLeave = overlay.onMouseLeave,
      onRemoved = overlay.onRemoved,
    ...
    this.visible = visible !== null && visible !== void 0 ? visible : true;
    this.zLevel = zLevel !== null && zLevel !== void 0 ? zLevel : 0;
    this.needDefaultPointFigure =
      needDefaultPointFigure !== null && needDefaultPointFigure !== void 0 ? needDefaultPointFigure : false;
    this.needDefaultXAxisFigure =
      needDefaultXAxisFigure !== null && needDefaultXAxisFigure !== void 0 ? needDefaultXAxisFigure : false;
    this.needDefaultYAxisFigure =
      needDefaultYAxisFigure !== null && needDefaultYAxisFigure !== void 0 ? needDefaultYAxisFigure : false;
    ...
    this.performEventPressedMove =
      performEventPressedMove !== null && performEventPressedMove !== void 0 ? performEventPressedMove : null;
    this.performEventMoveForDrawing =
      performEventMoveForDrawing !== null && performEventMoveForDrawing !== void 0 ? performEventMoveForDrawing : null;
  ...
  OverlayImp.prototype.eventMoveForDrawing = function (point) {
    ...
    (_a = this.performEventMoveForDrawing) === null || _a === void 0
      ? void 0
      : _a.call(this, {
          currentStep: this.currentStep,
          mode: this.mode,
  ...
  OverlayImp.prototype.eventPressedPointMove = function (point, pointIndex) {
    ...
    (_a = this.performEventPressedMove) === null || _a === void 0
      ? void 0
      : _a.call(this, {
          currentStep: this.currentStep,
          points: this.points,
    ...
    if (this._prevPressedPoint !== null) {
      ...
      this.points = this._prevPressedPoints.map(function (p) {
        ...
        if (isNumber(difDataIndex_1) && isNumber(p.dataIndex)) {
          ...
          newPoint.timestamp =
            (_a = timeScaleStore.dataIndexToTimestamp(newPoint.dataIndex)) !== null && _a !== void 0 ? _a : undefined;
        }
...
function createId(prefix) {
  ...
  return ''
    .concat(prefix !== null && prefix !== void 0 ? prefix : '')
    .concat(timestamp, '_')
    .concat(baseId);
}
...
var TimeScaleStore = /** @class */ (function () {
  ...
  TimeScaleStore.prototype.adjustVisibleRange = function () {
    ...
    var realFrom =
      this._lastBarRightSideDiffBarCount > 0
        ? Math.round(totalBarCount + this._lastBarRightSideDiffBarCount - visibleBarCount) - 1
        : from;
    ...
    if (from === 0) {
      ...
      this._chartStore.executeLoadMoreCallback(
        (_a = firstData === null || firstData === void 0 ? void 0 : firstData.timestamp) !== null && _a !== void 0
          ? _a
          : null
      );
  ...
  TimeScaleStore.prototype.zoom = function (scale, coordinate) {
    ...
    if (!isNumber(zoomCoordinate === null || zoomCoordinate === void 0 ? void 0 : zoomCoordinate.x)) {
      ...
      zoomCoordinate = {
        x:
          (_a = crosshair === null || crosshair === void 0 ? void 0 : crosshair.x) !== null && _a !== void 0
            ? _a
...
var averagePrice = {
  ...
  calc: function (dataList) {
    ...
    return dataList.map(function (kLineData) {
      ...
      var avp = {};
      var turnover =
        (_a = kLineData === null || kLineData === void 0 ? void 0 : kLineData.turnover) !== null && _a !== void 0
          ? _a
          : 0;
      var volume =
        (_b = kLineData === null || kLineData === void 0 ? void 0 : kLineData.volume) !== null && _b !== void 0
          ? _b
          : 0;
  ...
  figures: [
    {
      ...
      styles: function (data, indicator, defaultStyles) {
        ...
        var prevAo =
          (_b = (_a = prev.indicatorData) === null || _a === void 0 ? void 0 : _a.ao) !== null && _b !== void 0
            ? _b
            : Number.MIN_SAFE_INTEGER;
        var currentAo =
          (_d = (_c = current.indicatorData) === null || _c === void 0 ? void 0 : _c.ao) !== null && _d !== void 0
            ? _d
            : Number.MIN_SAFE_INTEGER;
        var color;
        if (currentAo > prevAo) {
  ...
  calc: function (dataList, indicator) {
    ...
    return dataList.map(function (kLineData, i) {
      ...
      if (i >= params[0] - 1) {
        ...
        var agoPreClose = (
          (_b = dataList[i - params[0]]) !== null && _b !== void 0 ? _b : dataList[i - (params[0] - 1)]
        ).close;
    ...
    { key: 'dea', title: 'DEA: ', type: 'line' },
    {
      ...
      styles: function (data, indicator, defaultStyles) {
        ...
        var prev = data.prev,
          current = data.current;
        var prevMacd =
          (_b = (_a = prev.indicatorData) === null || _a === void 0 ? void 0 : _a.macd) !== null && _b !== void 0
            ? _b
            : Number.MIN_SAFE_INTEGER;
        var currentMacd =
          (_d = (_c = current.indicatorData) === null || _c === void 0 ? void 0 : _c.macd) !== null && _d !== void 0
            ? _d
            : Number.MIN_SAFE_INTEGER;
        var color;
        if (currentMacd > 0) {
...
var rateOfChange = {
  ...
  calc: function (dataList, indicator) {
    ...
    dataList.forEach(function (kLineData, i) {
      ...
      if (i >= params[0] - 1) {
        var close_1 = kLineData.close;
        var agoClose = ((_a = dataList[i - params[0]]) !== null && _a !== void 0 ? _a : dataList[i - (params[0] - 1)])
          .close;
        if (agoClose !== 0) {
  ...
  calc: function (dataList, indicator) {
    ...
    dataList.forEach(function (kLineData, i) {
      ...
      if (i >= params[0] - 1) {
        ...
        kdj.k =
          ((params[1] - 1) *
            ((_b = (_a = result[i - 1]) === null || _a === void 0 ? void 0 : _a.k) !== null && _b !== void 0
              ? _b
              : 50) +
            rsv) /
          params[1];
        kdj.d =
          ((params[2] - 1) *
            ((_d = (_c = result[i - 1]) === null || _c === void 0 ? void 0 : _c.d) !== null && _d !== void 0
              ? _d
              : 50) +
            kdj.k) /
          params[2];
  ...
  figures: [
    {
      ...
      styles: function (data, indicator, defaultStyles) {
        ...
        var sar =
          (_b = (_a = current.indicatorData) === null || _a === void 0 ? void 0 : _a.sar) !== null && _b !== void 0
            ? _b
            : Number.MIN_SAFE_INTEGER;
        var kLineData = current.kLineData;
        var halfHL =
          ((kLineData === null || kLineData === void 0 ? void 0 : kLineData.high) +
            (kLineData === null || kLineData === void 0 ? void 0 : kLineData.low)) /
          2;
        var color =
          sar < halfHL
...
var IndicatorStore = /** @class */ (function () {
  ...
  IndicatorStore.prototype._sort = function (paneId) {
    var _a;
    if (isString(paneId)) {
      (_a = this._instances.get(paneId)) === null || _a === void 0
        ? void 0
        : _a.sort(function (i1, i2) {
          ...
          case 0:
            ...
            if (isString(name)) {
              if (isString(paneId)) {
                ...
                this._instances.forEach(function (paneInstances) {
                  var instance = paneInstances.find(function (ins) {
                    return ins.name === name;
                  });
                  if (isValid(instance)) {
  ...
  IndicatorStore.prototype.getInstanceByPaneId = function (paneId, name) {
    ...
    if (isString(paneId)) {
      ...
      if (isString(name)) {
        return (_b =
          paneInstances === null || paneInstances === void 0
            ? void 0
            : paneInstances.find(function (ins) {
                return ins.name === name;
              })) !== null && _b !== void 0
          ? _b
          : null;
  ...
  IndicatorStore.prototype.synchronizeSeriesPrecision = function (indicator) {
    var _a = this._chartStore.getPrecision(),
...
var TooltipStore = /** @class */ (function () {
  ...
  TooltipStore.prototype.setCrosshair = function (crosshair, options) {
    var _a = options !== null && options !== void 0 ? options : {},
      notInvalidate = _a.notInvalidate,
      notExecuteAction = _a.notExecuteAction;
    var dataList = this._chartStore.getDataList();
    ...
    if (prevCrosshair.x !== cr.x || prevCrosshair.y !== cr.y || prevCrosshair.paneId !== cr.paneId) {
      if (
        kLineData !== null &&
        !(notExecuteAction !== null && notExecuteAction !== void 0 ? notExecuteAction : false)
      ) {
...
var fibonacciLine = {
  ...
  createPointFigures: function (_a) {
    ...
    var coordinates = _a.coordinates,
      ...
      decimalFoldThreshold = _a.decimalFoldThreshold,
      yAxis = _a.yAxis;
    var points = overlay.points;
    if (coordinates.length > 0) {
      var currentPrecision_1 = (
        (_b = yAxis === null || yAxis === void 0 ? void 0 : yAxis.isInCandle()) !== null && _b !== void 0 ? _b : true
      )
        ? precision.price
      ...
      if (coordinates.length > 1 && isNumber(points[0].value) && isNumber(points[1].value)) {
        ...
        percents.forEach(function (percent) {
          ...
          var value = formatFoldDecimal(
            formatThousands(
              (((_a = points[1].value) !== null && _a !== void 0 ? _a : 0) + valueDif_1 * percent).toFixed(
                currentPrecision_1
              ),
              thousandsSeparator
            ),
...
var simpleTag = {
  ...
  createYAxisFigures: function (_a) {
    ...
    var overlay = _a.overlay,
      ...
      precision = _a.precision;
    var isFromZero =
      (_b = yAxis === null || yAxis === void 0 ? void 0 : yAxis.isFromZero()) !== null && _b !== void 0 ? _b : false;
    var textAlign;
    var x;
    if (isFromZero) {
      textAlign = 'left';
...
var OverlayStore = /** @class */ (function () {
  ...
  OverlayStore.prototype.progressInstanceComplete = function () {
    var _a;
    if (this._progressInstanceInfo !== null) {
      var _b = this._progressInstanceInfo,
  ...
  OverlayStore.prototype.override = function (overlay) {
    ...
    if (isString(id)) {
      ...
      this._instances.forEach(function (paneInstances) {
        paneInstances.forEach(function (instance) {
          if (
            (nameValid_1 && instance.name === name) ||
      ...
      if (this._progressInstanceInfo !== null) {
        ...
        if (
          (nameValid_1 && progressInstance.name === name) ||
  ...
  OverlayStore.prototype.setHoverInstanceInfo = function (info, event) {
    var _a, _b;
    var _c = this._hoverInstanceInfo,
      instance = _c.instance,
      figureType = _c.figureType,
      figureKey = _c.figureKey,
      figureIndex = _c.figureIndex;
    if (
      (instance === null || instance === void 0 ? void 0 : instance.id) !==
        ((_a = info.instance) === null || _a === void 0 ? void 0 : _a.id) ||
      ...
      if (
        (instance === null || instance === void 0 ? void 0 : instance.id) !==
        ((_b = info.instance) === null || _b === void 0 ? void 0 : _b.id)
      ) {
        ...
        if (instance !== null) {
          ...
          if (isFunction(instance.onMouseLeave)) {
            instance.onMouseLeave(
              __assign({ overlay: instance, figureKey: figureKey, figureIndex: figureIndex }, event)
            );
        ...
        if (info.instance !== null) {
          ...
          if (isFunction(info.instance.onMouseEnter)) {
            info.instance.onMouseEnter(
              __assign({ overlay: info.instance, figureKey: info.figureKey, figureIndex: info.figureIndex }, event)
            );
            ignoreUpdateFlag = true;
          }
        }
  ...
  OverlayStore.prototype.setClickInstanceInfo = function (info, event) {
    ...
    var _k = this._clickInstanceInfo,
      paneId = _k.paneId,
      instance = _k.instance,
      figureType = _k.figureType,
      figureKey = _k.figureKey,
      figureIndex = _k.figureIndex;
    if (
      !((_b = (_a = info.instance) === null || _a === void 0 ? void 0 : _a.isDrawing()) !== null && _b !== void 0
        ? _b
        : false)
    ) {
      (_d = (_c = info.instance) === null || _c === void 0 ? void 0 : _c.onClick) === null || _d === void 0
        ? void 0
        : _d.call(
            _c,
            __assign({ overlay: info.instance, figureKey: info.figureKey, figureIndex: info.figureIndex }, event)
    ...
    if (
      (instance === null || instance === void 0 ? void 0 : instance.id) !==
        ((_e = info.instance) === null || _e === void 0 ? void 0 : _e.id) ||
      figureType !== info.figureType ||
      figureIndex !== info.figureIndex
    ) {
      ...
      if (
        (instance === null || instance === void 0 ? void 0 : instance.id) !==
        ((_f = info.instance) === null || _f === void 0 ? void 0 : _f.id)
      ) {
        (_g = instance === null || instance === void 0 ? void 0 : instance.onDeselected) === null || _g === void 0
          ? void 0
          : _g.call(instance, __assign({ overlay: instance, figureKey: figureKey, figureIndex: figureIndex }, event));
        (_j = (_h = info.instance) === null || _h === void 0 ? void 0 : _h.onSelected) === null || _j === void 0
          ? void 0
          : _j.call(
              _h,
              __assign({ overlay: info.instance, figureKey: info.figureKey, figureIndex: info.figureIndex }, event)
  ...
  OverlayStore.prototype.isDrawing = function () {
    ...
    return (
      this._progressInstanceInfo !== null &&
      ((_b = (_a = this._progressInstanceInfo) === null || _a === void 0 ? void 0 : _a.instance.isDrawing()) !== null &&
      _b !== void 0
        ? _b
        : false)
    );
...
var ChartStore = /** @class */ (function () {
  ...
  ChartStore.prototype.adjustVisibleDataList = function () {
    this._visibleDataList = [];
    var _a = this._timeScaleStore.getVisibleRange(),
  ...
  ChartStore.prototype.setOptions = function (options) {
    ...
    if (isValid(options)) {
      var locale = options.locale,
        ...
        decimalFoldThreshold = options.decimalFoldThreshold;
      if (isString(locale)) {
        this._locale = locale;
      }
      if (isString(timezone)) {
      ...
      if (isValid(styles)) {
        ...
        if (
          isArray(
            (_b =
              (_a = ss === null || ss === void 0 ? void 0 : ss.candle) === null || _a === void 0
                ? void 0
                : _a.tooltip) === null || _b === void 0
              ? void 0
              : _b.custom
          )
        ) {
          this._styles.candle.tooltip.custom =
            (_d =
              (_c = ss === null || ss === void 0 ? void 0 : ss.candle) === null || _c === void 0
                ? void 0
                : _c.tooltip) === null || _d === void 0
              ? void 0
              : _d.custom;
        }
      }
      ...
      .then(function (result) {
        ...
        if (result) {
          _this._resizeObserver = new ResizeObserver(function (entries) {
            ...
            var size =
              (_a = entry === null || entry === void 0 ? void 0 : entry.devicePixelContentBoxSize) === null ||
              _a === void 0
                ? void 0
                : _a[0];
            if (isValid(size)) {
...
var Widget = /** @class */ (function (_super) {
  ...
  Widget.prototype.update = function (level) {
    this.updateImp(
      this._container,
      this._bounding,
      level !== null && level !== void 0 ? level : 3 /* UpdateLevel.Drawer */
    );
  };
...
function checkCoordinateOnPolygon(coordinate, attrs) {
  ...
  for (var i = 0; i < polygons.length; i++) {
    ...
    for (var i_1 = 0, j = coordinates.length - 1; i_1 < coordinates.length; j = i_1++) {
      if (
        coordinates[i_1].y > coordinate.y !== coordinates[j].y > coordinate.y &&
        coordinate.x <
          ((coordinates[j].x - coordinates[i_1].x) * (coordinate.y - coordinates[i_1].y)) /
            (coordinates[j].y - coordinates[i_1].y) +
            coordinates[i_1].x
      ) {
        on = !on;
      }
...
function checkCoordinateOnText(coordinate, attrs, styles) {
  ...
  for (var i = 0; i < texts.length; i++) {
    var _a = getTextRect(texts[i], styles),
      x = _a.x,
      y = _a.y,
      width = _a.width,
      height = _a.height;
    ...
    if (candleBarOptions !== null) {
      ...
      this.eachChildren(function (data, barSpace) {
        var kLineData = data.data,
          x = data.x;
        if (isValid(kLineData)) {
          var open_1 = kLineData.open,
            high = kLineData.high,
            low = kLineData.low,
            close_1 = kLineData.close;
          var type = candleBarOptions.type,
            styles = candleBarOptions.styles;
          var colors = [];
          if (close_1 > open_1) {
...
var IndicatorView = /** @class */ (function (_super) {
  ...
  IndicatorView.prototype.getCandleBarOptions = function (chartStore) {
    ...
    if (!yAxis.isInCandle()) {
      ...
      try {
        for (
          var indicators_1 = __values(indicators), indicators_1_1 = indicators_1.next();
          !indicators_1_1.done;
          indicators_1_1 = indicators_1.next()
        ) {
          ...
          _this.eachChildren(function (data, barSpace) {
            ...
            eachFigures(dataList, indicator, dataIndex, defaultStyles, function (figure, figureStyles, figureIndex) {
              ...
              if (isValid(currentData === null || currentData === void 0 ? void 0 : currentData[figure.key])) {
                ...
                var attrs =
                  (_a = figure.attrs) === null || _a === void 0
                    ? void 0
                    : _a.call(figure, {
                ...
                if (!isValid(attrs)) {
                  switch (figure.type) {
                    ...
                    case 'bar': {
                      ...
                      if (
                        baseValue !==
                        (currentData === null || currentData === void 0 ? void 0 : currentData[figure.key])
                      ) {
...
var IndicatorTooltipView = /** @class */ (function (_super) {
    ...
    _this._boundIconClickEvent = function (currentIcon) {
      return function () {
        ...
        pane
          ...
          .getChartStore()
          .getActionStore()
          .execute(ActionType.OnTooltipIconClick, __assign({}, currentIcon));
        return true;
      };
    };
  ...
  IndicatorTooltipView.prototype.drawIndicatorTooltip = function (
    ctx,
    paneId,
    dataList,
    crosshair,
    ...
    if (this.isDrawTooltip(crosshair, tooltipStyles)) {
      ...
      indicators.forEach(function (indicator) {
        ...
        var _a = _this.getIndicatorTooltipData(
            dataList,
            crosshair,
            indicator,
            customApi,
        ...
        if (nameValid || legendValid) {
          var _b = __read(_this.classifyTooltipIcons(icons), 3),
            leftIcons = _b[0],
            middleIcons = _b[1],
            rightIcons = _b[2];
          prevRowHeight = _this.drawStandardTooltipIcons(
            ctx,
            activeTooltipIcon,
            leftIcons,
            coordinate,
          ...
          if (nameValid) {
            ...
            prevRowHeight = _this.drawStandardTooltipLegends(
              ctx,
              [
                {
  ...
  IndicatorTooltipView.prototype.drawStandardTooltipIcons = function (
    ctx,
    activeIcon,
    icons,
    coordinate,
    ...
    if (icons.length > 0) {
      ...
      icons.forEach(function (icon) {
        var _a;
        var _b = icon.marginLeft,
          marginLeft = _b === void 0 ? 0 : _b,
          _c = icon.marginTop,
        ...
        var active =
          (activeIcon === null || activeIcon === void 0 ? void 0 : activeIcon.paneId) === paneId &&
          (activeIcon === null || activeIcon === void 0 ? void 0 : activeIcon.indicatorName) === indicatorName &&
          (activeIcon === null || activeIcon === void 0 ? void 0 : activeIcon.iconId) === icon.id;
        (_a = _this.createFigure(
          ...
          {
            mouseClickEvent: _this._boundIconClickEvent({
              paneId: paneId,
              indicatorName: indicatorName,
              iconId: icon.id,
            }),
            mouseMoveEvent: _this._boundIconMouseMoveEvent({
              paneId: paneId,
              indicatorName: indicatorName,
              iconId: icon.id,
            }),
  ...
  IndicatorTooltipView.prototype.drawStandardTooltipLegends = function (
    ctx,
    legends,
    coordinate,
    left,
  ...
  IndicatorTooltipView.prototype.isDrawTooltip = function (crosshair, styles) {
    ...
    return (
      showRule === TooltipShowRule.Always || (showRule === TooltipShowRule.FollowCross && isString(crosshair.paneId))
    );
  };
  IndicatorTooltipView.prototype.getIndicatorTooltipData = function (
    dataList,
    crosshair,
    indicator,
    customApi,
    ...
    if (indicator.createTooltipDataSource !== null) {
      ...
      var _c = indicator.createTooltipDataSource({
        ...
        customLegends = _c.values,
        customIcons = _c.icons;
...
var OverlayView = /** @class */ (function (_super) {
    ...
    this.registerEvent('mouseMoveEvent', function (event) {
      ...
      if (progressInstanceInfo !== null) {
        ...
        if (overlay.isDrawing() && progressInstancePaneId === paneId) {
          ...
          (_a = overlay.onDrawing) === null || _a === void 0
            ? void 0
            : _a.call(overlay, __assign({ overlay: overlay, figureKey: key, figureIndex: index }, event));
        }
        ...
        if (progressInstanceInfo !== null) {
          ...
          if (overlay.isDrawing() && progressInstancePaneId === paneId) {
            ...
            if (!overlay.isDrawing()) {
              ...
              (_b = overlay.onDrawEnd) === null || _b === void 0
                ? void 0
                : _b.call(overlay, __assign({ overlay: overlay, figureKey: key, figureIndex: index }, event));
            }
          }
        ...
        if (progressInstanceInfo !== null) {
          ...
          if (overlay.isDrawing() && progressInstancePaneId === paneId) {
            ...
            if (!overlay.isDrawing()) {
              ...
              (_a = overlay.onDrawEnd) === null || _a === void 0
                ? void 0
                : _a.call(overlay, __assign({ overlay: overlay, figureKey: key, figureIndex: index_1 }, event));
            }
          }
          var index = overlay.points.length - 1;
          return _this._figureMouseClickEvent(
            overlay,
            1 /* EventOverlayInfoFigureType.Point */,
            ''.concat(OVERLAY_FIGURE_KEY_PREFIX, 'point_').concat(index),
            index,
            0
          )(event);
        }
      ...
      .registerEvent('mouseRightClickEvent', function (event) {
        ...
        if (progressInstanceInfo !== null) {
          ...
          if (overlay.isDrawing()) {
            var index = overlay.points.length - 1;
            return _this._figureMouseRightClickEvent(
              overlay,
              1 /* EventOverlayInfoFigureType.Point */,
              ''.concat(OVERLAY_FIGURE_KEY_PREFIX, 'point_').concat(index),
              index,
      ...
      .registerEvent('mouseUpEvent', function (event) {
        var _a;
        var _b = overlayStore.getPressedInstanceInfo(),
          instance = _b.instance,
          figureIndex = _b.figureIndex,
          figureKey = _b.figureKey;
        if (instance !== null) {
          (_a = instance.onPressedMoveEnd) === null || _a === void 0
            ? void 0
            : _a.call(instance, __assign({ overlay: instance, figureKey: figureKey, figureIndex: figureIndex }, event));
        }
      ...
      .registerEvent('pressedMouseMoveEvent', function (event) {
        var _a, _b;
        var _c = overlayStore.getPressedInstanceInfo(),
          instance = _c.instance,
          figureType = _c.figureType,
          figureIndex = _c.figureIndex,
          figureKey = _c.figureKey;
        if (instance !== null) {
          if (!instance.lock) {
            if (
              !((_b =
                (_a = instance.onPressedMoving) === null || _a === void 0
                  ? void 0
                  : _a.call(
                      instance,
                      __assign({ overlay: instance, figureIndex: figureIndex, figureKey: figureKey }, event)
                    )) !== null && _b !== void 0
                ? _b
                : false)
            ) {
              ...
              if (figureType === 1 /* EventOverlayInfoFigureType.Point */) {
                ...
                instance.eventPressedOtherMove(
                  point,
                  _this.getWidget().getPane().getChart().getChartStore().getTimeScaleStore()
                );
              }
            }
          }
  ...
  OverlayView.prototype._createFigureEvents = function (
    overlay,
    figureType,
    figureKey,
    figureIndex,
  ...
  OverlayView.prototype._figureMouseDownEvent = function (overlay, figureType, figureKey, figureIndex, attrsIndex) {
    ...
    return function (event) {
      ...
      (_a = overlay.onPressedMoveStart) === null || _a === void 0
        ? void 0
        : _a.call(overlay, __assign({ overlay: overlay, figureIndex: figureIndex, figureKey: figureKey }, event));
      overlayStore.setPressedInstanceInfo({
        paneId: paneId,
        instance: overlay,
        figureType: figureType,
  ...
  OverlayView.prototype._figureMouseDoubleClickEvent = function (
    overlay,
    _figureType,
    figureKey,
    figureIndex,
    ...
    return function (event) {
      var _a;
      (_a = overlay.onDoubleClick) === null || _a === void 0
        ? void 0
        : _a.call(
            overlay,
            __assign(__assign({}, event), { figureIndex: figureIndex, figureKey: figureKey, overlay: overlay })
          );
      return true;
    };
  };
  OverlayView.prototype._figureMouseRightClickEvent = function (
    overlay,
    _figureType,
    figureKey,
    figureIndex,
    ...
    return function (event) {
      ...
      if (
        !((_b =
          (_a = overlay.onRightClick) === null || _a === void 0
            ? void 0
            : _a.call(
                overlay,
                __assign({ overlay: overlay, figureIndex: figureIndex, figureKey: figureKey }, event)
              )) !== null && _b !== void 0
          ? _b
          : false)
      ) {
  ...
  OverlayView.prototype.drawImp = function (ctx) {
    ...
    var overlayPrecision = paneIndicators.reduce(
      function (prev, indicator) {
  ...
  OverlayView.prototype._drawOverlay = function (
    ctx,
    overlay,
    bounding,
    barSpace,
    ...
    var coordinates = points.map(function (point) {
      ...
      if (isNumber(dataIndex)) {
        coordinate.x =
          (_a = xAxis === null || xAxis === void 0 ? void 0 : xAxis.convertToPixel(dataIndex)) !== null && _a !== void 0
            ? _a
            : 0;
      }
      if (isNumber(point.value)) {
        coordinate.y =
          (_b = yAxis === null || yAxis === void 0 ? void 0 : yAxis.convertToPixel(point.value)) !== null &&
          _b !== void 0
            ? _b
            : 0;
      }
  ...
  OverlayView.prototype.drawFigures = function (ctx, overlay, figures, defaultStyles) {
    ...
    figures.forEach(function (figure, figureIndex) {
      var type = figure.type,
        ...
        attrs = figure.attrs,
        ignoreEvent = figure.ignoreEvent;
      // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
      var attrsArray = [].concat(attrs);
      attrsArray.forEach(function (ats, attrsIndex) {
        var _a, _b, _c;
        var events = _this._createFigureEvents(
          overlay,
          2 /* EventOverlayInfoFigureType.Other */,
          (_a = figure.key) !== null && _a !== void 0 ? _a : '',
          figureIndex,
          attrsIndex,
          ignoreEvent
        );
        var ss = __assign(
          __assign(
            __assign({}, defaultStyles[type]),
            (_b = overlay.styles) === null || _b === void 0 ? void 0 : _b[type]
          ),
          styles
        );
        (_c = _this.createFigure(
  ...
  OverlayView.prototype.getFigures = function (
    overlay,
    coordinates,
    bounding,
    barSpace,
    ...
    var _a, _b;
    return (_b =
      (_a = overlay.createPointFigures) === null || _a === void 0
        ? void 0
        : _a.call(overlay, {
            overlay: overlay,
  ...
  OverlayView.prototype.drawDefaultFigures = function (
    ctx,
    overlay,
    coordinates,
    _bounding,
    ...
    if (overlay.needDefaultPointFigure) {
      if (
        (((_a = hoverInstanceInfo.instance) === null || _a === void 0 ? void 0 : _a.id) === overlay.id &&
        ...
        var pointStyles_1 = __assign(
          __assign({}, defaultStyles.point),
          styles === null || styles === void 0 ? void 0 : styles.point
        );
        coordinates.forEach(function (_a, index) {
          ...
          if (
            ((_b = hoverInstanceInfo.instance) === null || _b === void 0 ? void 0 : _b.id) === overlay.id &&
  ...
  CandleAreaView.prototype.drawImp = function (ctx) {
    ...
    if (pointStyles.show && isValid(ripplePointCoordinate)) {
      ...
      if (pointStyles.animation) {
        rippleRadius =
          pointStyles.radius +
          (this._animationFrameTime / pointStyles.animationDuration) * (pointStyles.rippleRadius - pointStyles.radius);
        this._animation.setDuration(pointStyles.animationDuration).start();
      }
      (_c = this._ripplePoint) === null || _c === void 0
        ? void 0
        : _c
            .setAttrs({
              x: ripplePointCoordinate.x,
    ...
    if (priceMarkStyles.show && (highPriceMarkStyles.show || lowPriceMarkStyles.show)) {
      ...
      if (highPriceMarkStyles.show && high_1 !== Number.MIN_SAFE_INTEGER) {
        this._drawMark(
          ctx,
          formatFoldDecimal(
            formatThousands(formatPrecision(high_1, precision.price), thousandsSeparator),
            decimalFoldThreshold
          ),
          { x: highX_1, y: highY },
          highY < lowY ? [-2, -5] : [2, 5],
      ...
      if (lowPriceMarkStyles.show && low_1 !== Number.MAX_SAFE_INTEGER) {
        this._drawMark(
          ctx,
          formatFoldDecimal(
            formatThousands(formatPrecision(low_1, precision.price), thousandsSeparator),
            decimalFoldThreshold
          ),
          { x: lowX_1, y: lowY },
          highY < lowY ? [2, 5] : [-2, -5],
...
function i18n(key, locale) {
  var _a, _b;
  return (_b = (_a = locales[locale]) === null || _a === void 0 ? void 0 : _a[key]) !== null && _b !== void 0
    ? _b
    : key;
}
...
var CandleTooltipView = /** @class */ (function (_super) {
  ...
  CandleTooltipView.prototype.drawImp = function (ctx) {
    ...
    if (isValid(crosshair.kLineData)) {
      ...
      if (
        ...
        var top_1 = this._drawCandleStandardTooltip(
          ctx,
          dataList,
          paneId,
          crosshair,
        ...
        var maxWidth = bounding.width - offsetRight;
        var top_2 = this.drawIndicatorTooltip(
          ctx,
          paneId,
          dataList,
          crosshair,
        ...
        var maxWidth = bounding.width - offsetRight;
        var top_3 = this._drawCandleStandardTooltip(
          ctx,
          dataList,
          paneId,
          crosshair,
  ...
  CandleTooltipView.prototype._drawCandleStandardTooltip = function (
    ctx,
    dataList,
    paneId,
    crosshair,
    ...
    if (this.isDrawTooltip(crosshair, tooltipStyles)) {
      ...
      var legends = this._getCandleTooltipLegends(
        {
          prev: (_b = dataList[dataIndex - 1]) !== null && _b !== void 0 ? _b : null,
          current: crosshair.kLineData,
          next: (_c = dataList[dataIndex + 1]) !== null && _c !== void 0 ? _c : null,
        },
        precision,
        dateTimeFormat,
        locale,
      ...
      var _d = __read(this.classifyTooltipIcons(tooltipStyles.icons), 3),
        leftIcons = _d[0],
        middleIcons = _d[1],
        rightIcons = _d[2];
  ...
  CandleTooltipView.prototype._drawRectTooltip = function (
    ctx,
    dataList,
    indicators,
    bounding,
    ...
    if (isDrawCandleTooltip || isDrawIndicatorTooltip) {
      ...
      var _f = candleTooltipStyles.text,
        baseTextMarginLeft_1 = _f.marginLeft,
        baseTextMarginRight_1 = _f.marginRight,
        baseTextMarginTop_1 = _f.marginTop,
        baseTextMarginBottom_1 = _f.marginBottom,
        baseTextSize_1 = _f.size,
        baseTextWeight_1 = _f.weight,
        baseTextFamily_1 = _f.family;
      var _g = candleTooltipStyles.rect,
        rectPosition = _g.position,
        rectPaddingLeft = _g.paddingLeft,
        rectPaddingRight_1 = _g.paddingRight,
        rectPaddingTop = _g.paddingTop,
        rectPaddingBottom = _g.paddingBottom,
        rectOffsetLeft = _g.offsetLeft,
        rectOffsetRight = _g.offsetRight,
        rectOffsetTop = _g.offsetTop,
        rectOffsetBottom = _g.offsetBottom,
        rectBorderSize_1 = _g.borderSize,
        rectBorderRadius = _g.borderRadius,
        rectBorderColor = _g.borderColor,
        rectBackgroundColor = _g.color;
      ...
      var _h = indicatorTooltipStyles.text,
        indicatorTextMarginLeft_1 = _h.marginLeft,
        indicatorTextMarginRight_1 = _h.marginRight,
        indicatorTextMarginTop_1 = _h.marginTop,
        indicatorTextMarginBottom_1 = _h.marginBottom,
        indicatorTextSize_1 = _h.size,
        indicatorTextWeight_1 = _h.weight,
        indicatorTextFamily_1 = _h.family;
      ...
      if (isDrawIndicatorTooltip) {
        ...
        indicators.forEach(function (indicator) {
          var _a;
          var tooltipDataValues =
            (_a = _this.getIndicatorTooltipData(
              dataList,
              crosshair,
              indicator,
              customApi,
      ...
      if (rectWidth_1 !== 0 && rectHeight_1 !== 0) {
        ...
        var isPointer =
          rectPosition === CandleTooltipRectPosition.Pointer && crosshair.paneId === PaneIdConstants.CANDLE;
  ...
  CandleTooltipView.prototype._getCandleTooltipLegends = function (
    ...
    var current = data.current;
    var prevClose =
      (_b = (_a = data.prev) === null || _a === void 0 ? void 0 : _a.close) !== null && _b !== void 0
        ? _b
        : current.close;
    var changeValue = current.close - prevClose;
    var pricePrecision = precision.price,
    ...
    var mapping = {
      ...
      '{open}': formatFoldDecimal(
        formatThousands(formatPrecision(current.open, pricePrecision), thousandsSeparator),
        decimalFoldThreshold
      ),
      '{high}': formatFoldDecimal(
        formatThousands(formatPrecision(current.high, pricePrecision), thousandsSeparator),
        decimalFoldThreshold
      ),
      '{low}': formatFoldDecimal(
        formatThousands(formatPrecision(current.low, pricePrecision), thousandsSeparator),
        decimalFoldThreshold
      ),
      '{close}': formatFoldDecimal(
        formatThousands(formatPrecision(current.close, pricePrecision), thousandsSeparator),
        decimalFoldThreshold
      ),
      '{volume}': formatFoldDecimal(
        formatThousands(
          customApi.formatBigNumber(
            formatPrecision(
              (_c = current.volume) !== null && _c !== void 0 ? _c : tooltipStyles.defaultValue,
              volumePrecision
            )
          ),
          thousandsSeparator
      ...
      '{turnover}': formatFoldDecimal(
        formatThousands(
          formatPrecision(
            (_d = current.turnover) !== null && _d !== void 0 ? _d : tooltipStyles.defaultValue,
            pricePrecision
          ),
          thousandsSeparator
        ),
      ...
      '{change}':
        prevClose === 0
          ...
          : ''.concat(formatThousands(formatPrecision((changeValue / prevClose) * 100), thousandsSeparator), '%'),
    };
    var legends =
      (_e = isFunction(tooltipStyles.custom) ? tooltipStyles.custom(data, styles) : tooltipStyles.custom) !== null &&
      _e !== void 0
        ? _e
        : [];
...
var OverlayYAxisView = /** @class */ (function (_super) {
  ...
  OverlayYAxisView.prototype.drawDefaultFigures = function (
    ctx,
    overlay,
    coordinates,
    bounding,
  ...
  OverlayYAxisView.prototype.getDefaultFigures = function (
    overlay,
    coordinates,
    bounding,
    precision,
    ...
    if (
      ...
      coordinates.forEach(function (coordinate, index) {
        ...
        if (isNumber(point.value)) {
          ...
          var text = formatFoldDecimal(
            formatThousands(formatPrecision(point.value, precision.price), thousandsSeparator),
            decimalFoldThreshold
          );
          figures.push({
            type: 'text',
            attrs: { x: x_1, y: coordinate.y, text: text, align: textAlign_1, baseline: 'middle' },
            ignoreEvent: true,
          });
        }
      });
      if (coordinates.length > 1) {
        figures.unshift({
          type: 'rect',
          attrs: { x: 0, y: topY_1, width: bounding.width, height: bottomY_1 - topY_1 },
          ignoreEvent: true,
        });
      }
    }
  ...
  OverlayYAxisView.prototype.getFigures = function (
    overlay,
    coordinates,
    bounding,
    barSpace,
    ...
    var _a, _b;
    return (_b =
      (_a = overlay.createYAxisFigures) === null || _a === void 0
        ? void 0
        : _a.call(overlay, {
            overlay: overlay,
            coordinates: coordinates,
...
function convertString(input) {
  // 使用正则表达式匹配格式 0.0{n}number
  const match = input.match(/^0\.0\{(\d+)\}(\d+)$/);
  if (match) {
    const zeroCount = parseInt(match[1], 10); // 提取 {n} 中的数字
    const numberPart = match[2]; // 提取后面的数字部分
    // 构造结果字符串
    return '0.' + '0'.repeat(zeroCount) + numberPart;
  } else {
    return input;
  }
}
...
var CrosshairHorizontalLabelView = /** @class */ (function (_super) {
    ...
    if (isString(crosshair.paneId) && this.compare(crosshair, pane.getId())) {
      if (styles.show) {
        ...
        if (directionStyles.show && textStyles.show) {
          ...
          var isCandlePane = crosshair.paneId === 'candle_pane';
          (_a = this.createFigure({
            name: 'text',
          ...
          if (isCandlePane) {
            (_b = this.createFigure({
              name: 'text',
              attrs: this.getTextAttrs(text, ctx.measureText(text).width, crosshair, bounding, axis, textStyles, 'top'),
              styles: __assign(
                {},
                textStyles
                // backgroundColor: colorRgb(textStyles.backgroundColor as string, 0.7)
              ),
            })) === null || _b === void 0
              ? void 0
              : _b.draw(ctx);
  ...
  CrosshairHorizontalLabelView.prototype.getTextAttrs = function (
    text,
    _textWidth,
    crosshair,
    bounding,
    ...
    if (baseline === 'top') {
      ...
      if (data != null && data.close) {
        ...
        let converted = convertString(text);
        let formattedClose = toNonExponential(data.close);
        text = (((converted.replace(/[^0-9.]/g, '') - formattedClose) / formattedClose) * 100).toFixed(precision) + '%';
        // text =
    ...
    return { x: x, y: crosshair.y, text: text, align: textAlign, baseline: baseline };
  };
...
var AxisImp = /** @class */ (function () {
  ...
  AxisImp.prototype._calcTicks = function () {
    var _a = this._range,
      realFrom = _a.realFrom,
      realTo = _a.realTo,
      realRange = _a.realRange;
    var ticks = [];
    if (realRange >= 0) {
      var _b = __read(this._calcTickInterval(realRange), 2),
        interval = _b[0],
        precision = _b[1];
...
var YAxisImp = /** @class */ (function (_super) {
  ...
  YAxisImp.prototype.calcRange = function () {
    ...
    var height =
      (_b = (_a = this.getParent().getYAxisWidget()) === null || _a === void 0 ? void 0 : _a.getBounding().height) !==
        null && _b !== void 0
        ? _b
        : 0;
    var paneGap = parent.getOptions().gap;
    var topRate =
      (_c = paneGap === null || paneGap === void 0 ? void 0 : paneGap.top) !== null && _c !== void 0 ? _c : 0.2;
    if (topRate >= 1) {
      topRate = topRate / height;
    }
    var bottomRate =
      (_d = paneGap === null || paneGap === void 0 ? void 0 : paneGap.bottom) !== null && _d !== void 0 ? _d : 0.1;
    if (bottomRate >= 1) {
  ...
  YAxisImp.prototype.optimalTicks = function (ticks) {
    ...
    var height =
      (_b = (_a = pane.getYAxisWidget()) === null || _a === void 0 ? void 0 : _a.getBounding().height) !== null &&
      _b !== void 0
        ? _b
        : 0;
    var chartStore = pane.getChart().getChartStore();
...
var DrawPane = /** @class */ (function (_super) {
  ...
  DrawPane.prototype.setOptions = function (options) {
    ...
    if (
      (_c = (_b = options.axisOptions) === null || _b === void 0 ? void 0 : _b.scrollZoomEnabled) !== null &&
      _c !== void 0
        ? _c
        : true
    ) {
...
var OverlayXAxisView = /** @class */ (function (_super) {
  ...
  OverlayXAxisView.prototype.getDefaultFigures = function (
    overlay,
    coordinates,
    bounding,
    _precision,
    ...
    if (
      ...
      coordinates.forEach(function (coordinate, index) {
        ...
        if (isNumber(point.timestamp)) {
          ...
          figures.push({
            type: 'text',
            attrs: { x: coordinate.x, y: 0, text: text, align: 'center' },
            ignoreEvent: true,
          });
        }
      });
      if (coordinates.length > 1) {
        figures.unshift({
          type: 'rect',
          attrs: { x: leftX_1, y: 0, width: rightX_1 - leftX_1, height: bounding.height },
          ignoreEvent: true,
        });
      }
    }
  ...
  OverlayXAxisView.prototype.getFigures = function (
    overlay,
    coordinates,
    bounding,
    barSpace,
    ...
    var _a, _b;
    return (_b =
      (_a = overlay.createXAxisFigures) === null || _a === void 0
        ? void 0
        : _a.call(overlay, {
            overlay: overlay,
            coordinates: coordinates,
...
var XAxisImp = /** @class */ (function (_super) {
  ...
  XAxisImp.prototype.calcRange = function () {
    ...
    var _a = chartStore.getTimeScaleStore().getVisibleRange(),
      from = _a.from,
      to = _a.to;
    var af = from;
    var at = to - 1;
  ...
  XAxisImp.prototype.optimalTicks = function (ticks) {
    ...
    if (tickLength > 0) {
      ...
      var defaultLabelWidth = calcTextWidth(
        '00-00 00:00',
        tickTextStyles.size,
      ...
      for (var i = 0; i < tickLength; i += tickCountDif) {
        ...
        if (i !== 0) {
          ...
          text =
            (_a = this._optimalTickLabel(formatDate, dateTimeFormat, timestamp, prevTimestamp)) !== null &&
            _a !== void 0
              ? _a
              : text;
        }
      ...
      if (optimalTickLength === 1) {
        ...
        if (isValid(optimalTicks[2])) {
          ...
          optimalTicks[0].text =
            (_b = this._optimalTickLabel(formatDate, dateTimeFormat, firstTimestamp, secondTimestamp)) !== null &&
            _b !== void 0
              ? _b
              : optimalTicks[0].text;
        }
...
var SeparatorWidget = /** @class */ (function (_super) {
  ...
  function SeparatorWidget(rootContainer, pane) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
    _this
      .registerEvent('touchStartEvent', _this._mouseDownEvent.bind(_this))
      // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
  ...
  SeparatorWidget.prototype._mouseEnterEvent = function () {
    ...
    if (
      (_a = bottomPane === null || bottomPane === void 0 ? void 0 : bottomPane.getOptions().dragEnabled) !== null &&
      _a !== void 0
        ? _a
        : false
    ) {
...
var SyntheticEvent = /** @class */ (function () {
    ...
    this._onMobileSafariDoubleClick = function (dblClickEvent) {
      if (_this._firesTouchEvents(dblClickEvent)) {
        ...
        if (_this._tapTimeoutId !== null && _this._tapCount > 1) {
          var manhattanDistance = _this._mouseTouchMoveWithDownInfo(
            _this._getCoordinate(dblClickEvent),
            _this._tapCoordinate
          ).manhattanDistance;
  ...
  SyntheticEvent.prototype._touchEndHandler = function (touchEndEvent) {
    ...
    if (this._tapTimeoutId !== null && this._tapCount > 1) {
      ...
      var manhattanDistance = this._mouseTouchMoveWithDownInfo(
    ...
    this._target.addEventListener(
      ...
      function (event) {
        ...
        if (isValid(_this._handler.pinchEvent)) {
          ...
          _this._handler.pinchEvent(
            __assign(__assign({}, _this._startPinchMiddleCoordinate), { pageX: 0, pageY: 0 }),
            scale
          );
...
var Event = /** @class */ (function () {
  ...
  Event.prototype.pinchEvent = function (e, scale) {
    var _a = this._findWidgetByEvent(e),
      ...
      widget = _a.widget;
    if (
      (pane === null || pane === void 0 ? void 0 : pane.getId()) !== PaneIdConstants.X_AXIS &&
      (widget === null || widget === void 0 ? void 0 : widget.getName()) === WidgetNameConstants.MAIN
    ) {
  ...
  Event.prototype.mouseMoveEvent = function (e) {
    ...
    var event = this._makeWidgetEvent(e, widget);
    if (
      ((_a = this._mouseMoveTriggerWidgetInfo.pane) === null || _a === void 0 ? void 0 : _a.getId()) !==
        (pane === null || pane === void 0 ? void 0 : pane.getId()) ||
      ((_b = this._mouseMoveTriggerWidgetInfo.widget) === null || _b === void 0 ? void 0 : _b.getName()) !==
        (widget === null || widget === void 0 ? void 0 : widget.getName())
    ) {
      widget === null || widget === void 0 ? void 0 : widget.dispatchEvent('mouseEnterEvent', event);
      (_c = this._mouseMoveTriggerWidgetInfo.widget) === null || _c === void 0
        ? void 0
        : _c.dispatchEvent('mouseLeaveEvent', event);
  ...
  Event.prototype.pressedMouseMoveEvent = function (e) {
    ...
    var _f = this._findWidgetByEvent(e),
      pane = _f.pane,
      widget = _f.widget;
    if (
      widget !== null &&
      ((_a = this._mouseDownWidget) === null || _a === void 0 ? void 0 : _a.getPane().getId()) ===
        (pane === null || pane === void 0 ? void 0 : pane.getId()) &&
      ...
      switch (name_3) {
        case WidgetNameConstants.MAIN: {
          ...
          if (!consumed && this._startScrollCoordinate !== null) {
            ...
            if (this._prevYAxisRange !== null && !yAxis.getAutoCalcTickFlag() && yAxis.getScrollZoomEnabled()) {
              var _g = this._prevYAxisRange,
                from = _g.from,
                to = _g.to,
                range = _g.range;
              var distance_1;
              if (
                (_c = yAxis === null || yAxis === void 0 ? void 0 : yAxis.isReverse()) !== null && _c !== void 0
                  ? _c
                  : false
              ) {
        ...
        case WidgetNameConstants.X_AXIS: {
          ...
          if (!consumed) {
            ...
            if (
              (_d = xAxis === null || xAxis === void 0 ? void 0 : xAxis.getScrollZoomEnabled()) !== null &&
              _d !== void 0
                ? _d
                : true
            ) {
      ...
      if (widget.getName() === WidgetNameConstants.MAIN) {
        ...
        if (result) {
          ...
          if (!this._touchCancelCrosshair && !this._touchZoomed) {
            ...
            tooltipStore.setCrosshair(
              { x: event_12.x, y: event_12.y, paneId: pane === null || pane === void 0 ? void 0 : pane.getId() },
              { notInvalidate: true }
            );
            consumed = true;
          }
  ...
  Event.prototype._findWidgetByEvent = function (event) {
    ...
    try {
      for (
        var separatorPanes_1 = __values(separatorPanes), separatorPanes_1_1 = separatorPanes_1.next();
        !separatorPanes_1_1.done;
        separatorPanes_1_1 = separatorPanes_1.next()
      ) {
    ...
    try {
      for (
        var drawPanes_1 = __values(drawPanes), drawPanes_1_1 = drawPanes_1.next();
        !drawPanes_1_1.done;
        drawPanes_1_1 = drawPanes_1.next()
      ) {
  ...
  Event.prototype._makeWidgetEvent = function (event, widget) {
    var _a, _b, _c;
    var bounding =
      (_a = widget === null || widget === void 0 ? void 0 : widget.getBounding()) !== null && _a !== void 0 ? _a : null;
    return __assign(__assign({}, event), {
      x:
        event.x -
        ((_b = bounding === null || bounding === void 0 ? void 0 : bounding.left) !== null && _b !== void 0 ? _b : 0),
      y:
        event.y -
        ((_c = bounding === null || bounding === void 0 ? void 0 : bounding.top) !== null && _c !== void 0 ? _c : 0),
    });
  };
...
var ChartImp = /** @class */ (function () {
  ...
  ChartImp.prototype._initPanes = function (options) {
    ...
    var _a;
    var layout =
      (_a = options === null || options === void 0 ? void 0 : options.layout) !== null && _a !== void 0
        ? _a
    ...
    switch (position) {
      ...
      default: {
        for (var i = this._drawPanes.length - 1; i > -1; i--) {
          ...
          if (
            (p === null || p === void 0 ? void 0 : p.getOptions().position) === 'bottom' /* PanePosition.Bottom */ &&
            (prevP === null || prevP === void 0 ? void 0 : prevP.getOptions().position) !==
              'bottom' /* PanePosition.Bottom */
          ) {
            pane = new DrawPaneClass(
              this._chartContainer,
              p.getContainer(),
      ...
      if (pane !== null) {
        ...
        if (options.id !== PaneIdConstants.CANDLE && isNumber(options.height) && options.height > 0) {
          var minHeight = Math.max(
            (_a = options.minHeight) !== null && _a !== void 0 ? _a : pane.getOptions().minHeight,
            0
          );
  ...
  ChartImp.prototype.adjustPaneViewport = function (
    shouldMeasureHeight,
    shouldMeasureWidth,
    shouldUpdate,
    shouldAdjustYAxis,
    shouldForceAdjustYAxis
  ) {
    ...
    var forceAdjustYAxis =
      shouldForceAdjustYAxis !== null && shouldForceAdjustYAxis !== void 0 ? shouldForceAdjustYAxis : false;
    ...
    if (actionStore.has(ActionType.OnCrosshairChange)) {
      ...
      if (isString(crosshair.paneId)) {
        actionStore.execute(
          ...
          __assign(__assign({}, crosshair), { indicatorData: indicatorData_1 })
        );
      }
    }
  };
      ...
      if (pane !== null) {
        ...
        switch (pos) {
          ...
          case DomPosition.YAxis: {
            return (_b = (_a = pane.getYAxisWidget()) === null || _a === void 0 ? void 0 : _a.getContainer()) !==
              null && _b !== void 0
              ? _b
              : null;
          }
    ...
    if (isValid(paneId)) {
      ...
      if (pane !== null) {
        ...
        switch (pos) {
          ...
          case DomPosition.YAxis: {
            return (_b = (_a = pane.getYAxisWidget()) === null || _a === void 0 ? void 0 : _a.getBounding()) !== null &&
              _b !== void 0
              ? _b
              : null;
          }
  ...
  ChartImp.prototype.setStyles = function (styles) {
    ...
    if (
      isValid(
        (_a = realStyles === null || realStyles === void 0 ? void 0 : realStyles.yAxis) === null || _a === void 0
          ? void 0
          : _a.type
      )
    ) {
  ...
  ChartImp.prototype.createIndicator = function (value, isStack, paneOptions, callback) {
    ...
    if (currentPane !== null) {
      this._chartStore
        ...
        .addInstance(
          indicator,
          paneId !== null && paneId !== void 0 ? paneId : '',
          isStack !== null && isStack !== void 0 ? isStack : false
        )
        .then(function (_) {
          var _a;
          _this._setPaneOptions(
            paneOptions !== null && paneOptions !== void 0 ? paneOptions : {},
            (_a = currentPane.getAxisComponent().buildTicks(true)) !== null && _a !== void 0 ? _a : false
          );
        })
        .catch(function (_) {});
    } else {
      paneId !== null && paneId !== void 0 ? paneId : (paneId = createId(PaneIdConstants.INDICATOR));
      var pane = this._createPane(
        IndicatorPane,
        paneId,
        paneOptions !== null && paneOptions !== void 0 ? paneOptions : {}
      );
      var height =
        (_a = paneOptions === null || paneOptions === void 0 ? void 0 : paneOptions.height) !== null && _a !== void 0
          ? _a
          : PANE_DEFAULT_HEIGHT;
      pane.setBounding({ height: height });
  ...
  ChartImp.prototype.scrollToRealTime = function (animationDuration) {
    ...
    var difBarCount =
      timeScaleStore.getLastBarRightSideDiffBarCount() - timeScaleStore.getInitialOffsetRightDistance() / barSpace;
  ...
  ChartImp.prototype.convertToPixel = function (points, finder) {
    var _a;
    var _b = finder.paneId,
      paneId = _b === void 0 ? PaneIdConstants.CANDLE : _b,
      _c = finder.absolute,
      ...
      if (pane !== null) {
        ...
        points = cs.map(function (coordinate) {
          ...
          if (isNumber(coordinate.x)) {
            var dataIndex =
              (_a = xAxis_2 === null || xAxis_2 === void 0 ? void 0 : xAxis_2.convertFromPixel(coordinate.x)) !==
                null && _a !== void 0
                ? _a
                : -1;
            point.dataIndex = dataIndex;
...
function dispose(dcs) {
  ...
  if (dcs instanceof ChartImp) {
    ...
    id =
      (_a = dom === null || dom === void 0 ? void 0 : dom.getAttribute('k-line-chart-id')) !== null && _a !== void 0
        ? _a
        : null;
  }
  if (id !== null) {
