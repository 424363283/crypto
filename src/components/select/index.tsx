    ...
    ({ methods, props, state }: { methods: any; props: any; state: any }) => {
      ...
      return (
        <div className='content'>
          ...
          <CommonIcon name={icon || 'common-tiny-triangle-down3'} size={16} />
        </div>
      );
    },
    [isDark, label]
  ...
  return (
    ...
    >
      <div className='dropdown-wrapper'>
        <DropdownSelect className={`layer${layer}`} contentRenderer={contentRenderer} closeOnClickInput {...rest} />
      </div>
      <style jsx>
        {`
          .select-wrapper {
            ...
            &:hover,
            &:focus {
              border-color:  ${bgColor || 'var(--fill_line_3) !important'};
            }
            .dropdown-wrapper {
              border-radius: 8px;
              width: 100%;
            ...
            :global(.react-dropdown-select.layer1) {
              border: 1px solid ${borderColor || 'var(--fill_input_1)'} !important;
              background-color:  ${bgColor || 'var(--fill_input_1)'};
            }
            :global(.react-dropdown-select.layer2){
              border: 1px solid ${borderColor || 'var(--fill_input_2)'} !important;
              background-color: ${bgColor || 'var(--fill_input_2)'};
            }
          }
