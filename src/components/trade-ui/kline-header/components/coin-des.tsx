    ...
    (async () => {
      ...
      if (item) {
        ...
        if (isSpotEtf(id)) {
          ...
          setData({ ...resultCommodityInfo.data, ...resultEtfCommodityInfo.data, ...item, isEtf: true, etfTitle,fullname:resultCommodityInfo.data.name });
        } else {
          setData({ ...resultCommodityInfo.data, ...item, isEtf: false,fullname:resultCommodityInfo.data.name });
        }
