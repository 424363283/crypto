  ...
  const content = (
    <div className={`calculator-content ${theme}`}>
      <div className="content">
        <div className="left">
          <QuoteSelect value={state.selectValue} list={state.selectList} onChange={onQuoteSelectChange} label="" />
    ...
    <>
      ...
      >
        <div className={`calculator-content ${theme}`}>
          ...
          <div className="content">
            <div className="left">
              <QuoteSelect value={state.selectValue} list={state.selectList} onChange={onQuoteSelectChange} />
              <TransactionTypeButton
                positionSide={state.positionSide}
                greenText={LANG('买多')}
                redText={LANG('卖空')}
