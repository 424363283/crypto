    ...
    <>
      <div className={clsx('all24', 'gap24', 'h346')}>
        ...
        <div className={clsx('flexSpace')}>
          ...
          <span className={clsx('textPrimary')}>{copyOverviewData.workDays || 0}</span>
        </div>
        <div className={clsx('flexSpace')}>
          ...
          <div className={clsx('textPrimary')}>
            <span>{copyOverviewData?.userAmount?.toFormat(Copy.copyFixed) || 0}</span>
          </div>
        </div>
        <div className={clsx('flexSpace')}>
          ...
          <span className={clsx('textPrimary')}>{copyOverviewData?.settledTotalAmount?.toFormat(Copy.copyFixed) || 0}</span>
        </div>
        <div className={clsx('flexSpace')}>
          ...
          <span className={clsx('textPrimary')}>{copyOverviewData.settledTotalProfit?.toFormat(Copy.copyFixed) || 0}</span>
        </div>
        <div className={clsx('flexSpace')}>
          ...
          <span className={clsx('textPrimary')}>{copyOverviewData.totalFollowers || 0}</span>
        </div>
        <div className={clsx('flexSpace')}>
          <Tooltip title={<p>{LANG('跟随此交易员盈利时需要贡献的利润比例。')}</p>}>
            <span className={clsx('textDashed')}>{LANG('分润比例')}</span>
          </Tooltip>
          <span className={clsx('textPrimary')}>{copyOverviewData?.shareRoyaltyRatio?.mul(100) || 0}%</span>
        </div>
      </div>
