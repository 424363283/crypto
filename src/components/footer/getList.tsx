  ...
  const list: { label: string; children: { label: string; href: string; blank?: boolean; tooltip?: boolean }[] }[] = [
    {
      ...
      children: [
        ...
        },
        {
          ...
          href: `https://support.y-mex.com/hc/${language}/categories/5708257368591-Announcements`,
          blank: true,
        },
        {
      ...
      children: [
        {
          ...
          href: `https://support.y-mex.com/hc/${language}`,
          blank: true,
        },
        {
          label: LANG('官方验证渠道'),
        ...
        {
          label: LANG('FAQ'),
          href: `https://support.y-mex.com/hc/${language}/categories/5715148191631-YMEX-FAQ`,
          blank: true,
        },
        {
          label: LANG('Trading Fees'),
          href: `https://support.y-mex.com/hc/${language}/articles/5699103361551-Transaction-Fee-Calculation`,
          blank: true,
        },
        {
          label: LANG('User Feedback'),
          href: `https://support.y-mex.com/hc/${language}/requests/new`,
          blank: true,
        },
        {
          label: LANG('Contact Us'),
          href: `https://support.y-mex.com/hc/${language}/sections/5754801031951-Contact-Us`,
          blank: true,
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          href: `https://support.y-mex.com/hc/en-us/articles/5990396901647`,
          blank: true,
        },
        {
          label: 'API',
