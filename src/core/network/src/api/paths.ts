...
export const paths = {
  ...
  get_market_config: '/api/setting/market-config', // 获取商品 market-config
  ...
  home_country_list: '/api/public/v1/country', // 国家列表
  ...
  kyc_config: '/api/user/kyc/config', // KYC配置
  ...
  user_detail: '/api/private/account/detail', // 用户详情
  ...
  account_suspect: '/api/spot/private/account/suspect', // 韩国kyc认证
  ...
  lite_history_transaction: '/api/lite/private/order/history_orders_page', // 差价合约历史分页
  ...
  lite_history_funds: '/api/lite/private/order/history_funds', // 简单合约资金流水
  lite_history_funds_v2: '/api/lite/private/v2/order/history_funds', // 简单合约资金流水v2
  ...
  toggle_withdraw_fast: '/api/private/account/set_withdraw_fast', // 打开/关闭提币免验证
  toggle_withdraw_white: '/api/spot/private/account/set_withdraw_white', // 打开/关闭仅地址簿提币
  get_favorites_list: '/api/private/favor/symbol/list', // 获取登录自选列表
  add_favorites: '/api/private/favor/symbol/add', // 添加自选
  remove_favorites_list: '/api/private/favor/symbol/remove', // 删除自选
  ...
  deposit_target_wallet: '/api/spot/private/address/deposit_target', // 充值目标地址
  //兑换
  ...
  // 新跟单接口
  copyTradeApplpy: '/swap/share/trade/apply', // 申请跟单
  shareTraderList:'/swap/copy/trade/shareTraderList',// 全部带单员列表信息
  ...
  copyTradeUserStatisticsList: '/swap/copy/statistics/copy_tradeuser_statistics_list',// 查询周期性带单员数据 K线
  copyTradeUserStatisticsSummary:'/swap/copy/statistics/copy_tradeuser_statistics_summary', // 查询带单员详情 周期信息
  ...
  shareTraderDetail:'/swap/copy/trade/shareTraderDetail', // 查询带单员详情
  getShareTraderList:'/swap/copy/trade/getSharedList', // 跟随交易员
  ...
  getSharedPnl:'/swap//copy/statistics/getSharedPnl', // 查询跟单用户收益信息
  ...
  getShareStatistics:'/swap/copy/royalty/getShareStatistics',  // 查询跟单员分润统计接口
  ...
  // partner
  partner_apply: '/api/agent/apply', //  代理商申请
  partner_apply_status:'/api/agent/apply/status',// 代理申请-状态
