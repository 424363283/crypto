...
export const DesktopSearch = () => {
  ...
  const columns = [
    ...
    },
    {
      title: LANG('来源'),
      dataIndex: 'source',
      render: (source: string) => (source ? source : '--'),
    },
    {
      title: () => {
        return (
      ...
      dataIndex: 'recharge',
      render: (recharge: string) => recharge.toFormat(scale),
    },
    {
      title: () => {
        return (
      ...
      dataIndex: 'withdraw',
      render: (withdraw: string) => withdraw.toFormat(scale),
    },
    {
      title: () => {
        return (
      ...
      render: (tradeAmount: string) => tradeAmount.toFormat(scale),
    },
    {
      title: () => {
        return (
      ...
      render: (tradeCount: string) => tradeCount,
    },
    {
      title: () => {
        return (
      ...
      render: (commissions: any) => {
        return (
          <div>
            <div>{formatDefaultText(commissions[currency]?.toFixed(scale))}</div>
          </div>
        );
      },
    },
      ...
      <div className='container'>
        ...
        <div className='user-table-wrapper'>
          <AffiliateTable
            ...
            total={total}
            page={page}
            paginationOnChange={(val) => UserDetail.onPageChange(val)}
            renderRowKey={(v) => v.uid}
          />
        </div>
      </div>
      <Modal
