      ...
      <div className="apply-trade-content">
        ...
        <div className='apply-trader-body vertically-align-center'>
          <div className='apply-slogan'>
            ...
            <Image className='apply-profit-20-h5' width='240' height='190' src={'/static/images/copy/apply-profit-20.svg'} alt='apply-profit' />
          ...
          <Image className='apply-profit-20' width='330' height='260' src={'/static/images/copy/apply-profit-20.svg'} alt='apply-profit' />
        </div>
      </div>
