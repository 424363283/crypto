...
export default Lang.SeoHead(WS3001(WS4001(SpotPage), { spot: true }));
export const getStaticPaths = Lang.getStaticPathsTradeCallback('spotids');
export const getStaticProps = Lang.getStaticProps({ key: MetaKey.spot });